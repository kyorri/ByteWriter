...
namespace ByteWriter.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            await _loginService.SignOutExternalAsync();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var result = await _loginService.PasswordSignInAsync(Input.Email, Input.Password, Input.RememberMe);
                if (result.Succeeded)
                {
